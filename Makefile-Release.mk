...
${OBJECTDIR}/sph.o: sph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sph.o sph.cpp
...
${OBJECTDIR}/tensorHeap.o: tensorHeap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/tensorHeap.o tensorHeap.cpp

${OBJECTDIR}/tensorglyph.o: tensorglyph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/tensorglyph.o tensorglyph.cpp

${OBJECTDIR}/octree.o: octree.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/octree.o octree.cpp
...
${OBJECTDIR}/newGrid.o: newGrid.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/newGrid.o newGrid.cpp

${OBJECTDIR}/gcgTensor.o: gcgTensor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/gcgTensor.o gcgTensor.cpp

${OBJECTDIR}/optimizedGrid.o: optimizedGrid.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/optimizedGrid.o optimizedGrid.cpp

${OBJECTDIR}/squadric.o: squadric.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/squadric.o squadric.cpp

${OBJECTDIR}/tensorgenerate.o: tensorgenerate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/tensorgenerate.o tensorgenerate.cpp

${OBJECTDIR}/superquadric.o: superquadric.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/superquadric.o superquadric.cpp

${OBJECTDIR}/tensorvisu.o: tensorvisu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/tensorvisu.o tensorvisu.cpp

${OBJECTDIR}/tensorgrid.o: tensorgrid.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/tensorgrid.o tensorgrid.cpp
